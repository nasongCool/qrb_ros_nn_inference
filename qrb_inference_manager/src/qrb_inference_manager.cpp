...
{
  // Current QrbInference interface only supports vector-based execution.
  // DMA-BUF path is implemented in QnnInference and is expected to be used with HTP backend.
